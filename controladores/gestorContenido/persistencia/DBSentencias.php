...
//CARACTERISTICAS
    const LISTAR_CARACTERISTICAS = "SELECT `id_caracteristicas` AS id, `denominacion_caracteristica` AS denominacion FROM caracteristicas WHERE borrado = 0";
    const LISTAR_TODO_CARACTERISTICAS = "SELECT `id_caracteristicas` AS id, `denominacion_caracteristica` AS denominacion FROM caracteristicas";
...
//EDITORIALES
    const LISTAR_EDITORIALES = "SELECT `id_editorial` AS id, `nombre_editorial` AS nombre FROM editoriales WHERE borrado = 0";
    const LISTAR_TODO_EDITORIALES = "SELECT `id_editorial` AS id, `nombre_editorial` AS nombre FROM editoriales";
